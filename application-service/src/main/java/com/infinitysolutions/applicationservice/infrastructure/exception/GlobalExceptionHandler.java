...
//    }
    ...
    private HttpStatus getStatusForException(ApplicationServiceException ex) {
        ...
        } else if (ex instanceof RecursoIncompativelException || ex instanceof com.infinitysolutions.applicationservice.infrastructure.exception.DocumentoInvalidoException) {
