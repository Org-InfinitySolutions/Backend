...
public class EmailTemplateBuilder {
    ...
    public String gerarTemplateRelatorioMensalPedidos(String mesAno, 
                                                     String totalPedidos,
                                                     String pedidosEmAnalise,
                                                     String pedidosAprovados,
                                                     String pedidosEmEvento,
                                                     String pedidosFinalizados,
                                                     String pedidosCancelados,
                                                     String pedidosIndoor,
                                                     String pedidosOutdoor,
                                                     String totalItensLocados,
                                                     String dataGeracao) {
        return """
                <!DOCTYPE html>
                <html lang="pt-BR">
        ...
        """.formatted(mesAno, totalPedidos, pedidosEmAnalise, pedidosAprovados, 
                     pedidosEmEvento, pedidosFinalizados, pedidosCancelados, 
                     pedidosIndoor, pedidosOutdoor, totalItensLocados, dataGeracao);
    }
}
